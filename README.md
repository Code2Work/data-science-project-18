# Data Science Python Project 18 — Olasılık Dağılımları (Binom, Poisson)
...
Örnek bir Lokasyon: Code2Work/DataScience/data-project-18.
...
# Questions
* Senaryo:
    Bir Witcher olarak canavar avlarının başarı olasılıklarını modelliyorsun.
    Binom ve Poisson dağılımlarını kullanarak av simülasyonları yapacak, olasılıkları hesaplayacak
    ve iki Witcher'ın performansını karşılaştıracaksın.
